...
namespace Crm.Api.Messaging.Infrastructure
{
    public static class EntityMap
    {
        // Neden: Entity alan adları farklı olduğunda compile-time hata üretmeden ilerlemek.
        public static void TrySet<T>(T entity, params (string Name, object? Value)[] assignments)
        {
            ...
            foreach (var (name, value) in assignments)
            {
                ...
                {
                    // MVP’de alan yoksa/uyuşmazsa atla.
                }
            }
        }
